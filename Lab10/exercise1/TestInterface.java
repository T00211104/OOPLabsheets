...
public class TestInterface {
    public static void main(String[] args) {
        ...
        TemporaryLecturer tl1 = new TemporaryLecturer("Ricard O'Neill","Dublin",new GregorianCalendar(1985,2,4),"3536278b",
                new String[] {"Applied Biology","MicroBiology"},new GregorianCalendar(2018,3,15));
        ...
        TemporaryLecturer tl2 = new TemporaryLecturer("Mary McKenzie","Bundoran, Donegal",new GregorianCalendar(1971,5,13),"647382",
                new String[]{"Fractal Geometry","Tensors"},new GregorianCalendar(2016,2,8));

        Person[] allPersons = {u1,u2,p1,p2,pl1,pl2,tl1,tl2};

        System.out.println("\n\nTesting the functionality of PermanentLecturer and TemporaryLecturer, as UnderGraduate and PostGraduate,\n + " +
