...
public abstract class Student implements Person {
    ...
    private String studentID; //part of student person
    private String course;    //part of student person

    public Student(){this("Undefined","Undefined",null,"Undefined","Undefined");
    }
