...
public class TestLineItem {
    public static void main(String[] args) {
        //Create an array of LineItems objects
        ...
        System.out.println("Now changing products associated with first line-item to a marker ... \n\n");
        item1.setProduct(p4);
        ...
        System.out.println("Displaying the state of the 2nd product ...\n");
