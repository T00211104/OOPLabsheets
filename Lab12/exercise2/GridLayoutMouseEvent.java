...
public class GridLayoutMouseEvent extends JFrame {
    ...
    private ImageIcon xImage = new ImageIcon("Lab12/sampleprogram2/images/cross.gif");
    private ImageIcon oImage = new ImageIcon("Lab12/sampleprogram2/images/nought.gif");
            ...
            currentLabel.addMouseListener(new MouseAdapter() {
                ...
                public void mouseClicked(MouseEvent e) {
                    ...
                    if(!label.getText().equals("")){
                        ...
                        JOptionPane.showMessageDialog(null,"This cell has already been clicked!","Error!!",JOptionPane.ERROR_MESSAGE);
                        clickEventCounter--;
                    }
                    ...
                    if(clickEventCounter==16&&clickEventCounter==0){
                        JOptionPane.showMessageDialog(null,"Neither Players win!","A Tie!!",
                                JOptionPane.INFORMATION_MESSAGE);
                        gameOver=true;
                    }
